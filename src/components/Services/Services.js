...
const Services = () => {
    return (
        <div className="service-container">
            <div>
            <div className="my-5" style={{position: 'relative', padding: '10px'}}><h2   className="text-center mt-5">Offer The Latest Software And <br /> Solutions To Our Customers!</h2></div>
